/****************************************************************************************
*  @author: kzvd4729                                         created: 2020-02-13 18:21:19                      
...
inline long ck2(long i,long j,long md)
{
...
inline long ck1(long i,long j,long md)
{
  long sml=0,s=0;
...
int main()
{
  ...
  for(long i=0;i<=n;i++)
  {
    for(long j=0;j<=n;j++)dp[i][j]=inf;
  }
  dp[0][0]=0;
  for(long i=1;i<=g;i++)dfs(i,1,n,1,n);
  cout<<dp[g][n]<<endl;
  return 0;
}