/****************************************************************************************
*  @author: kzvd4729                                         created: 2020-10-01 16:48:58                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time (ms): 120                                        memory_used (MB):                                 
*  problem: https://vjudge.net/problem/Kattis-fenceortho
****************************************************************************************/
#include<iostream>
#include<vector>
#include<cstring>
...
struct polygon
{
  ...
  */
  ...
  double minmumBoundingBox()//for minimum rectangle area and perimeter
  {
...
int main()  
{
  ...
  while(cin>>n)
  {
    ...
    p.convexHull();cout<<p.minmumBoundingBox()<<endl;
  }
  return 0;
}