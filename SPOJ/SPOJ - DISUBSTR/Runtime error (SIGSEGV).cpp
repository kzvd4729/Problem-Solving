/****************************************************************************************
*  @author: kzvd4729                                         created: 2019-08-22 16:36:35                      
...
struct suffixAutomata
{
  ...
  long lenMatch;//for number of distinct substring
  suffixAutomata()
  {
  ...
  void insrt(int c)
  {
    ...
    last=now;
    if(aut[last].link!=-1)lenMatch+=aut[aut[last].link].len;
  }
...
int main()
{
  ...
  while(t--)
  {
    ...
    long ans=s.size();ans*=(s.size()+1);ans/=2;
    cout<<ans-sam.lenMatch<<"\n";
  }
  return 0;
}