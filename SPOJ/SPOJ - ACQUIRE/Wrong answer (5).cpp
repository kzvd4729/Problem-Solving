/****************************************************************************************
*  @author: kzvd4729                                         created: 2018-10-24 01:46:19                      
...
{
  long fup=(stk[k].second-stk[i].second);
  long fdw=(stk[i].first-stk[k].first);

  long sup=(stk[k].second-stk[j].second);
  long sdw=(stk[j].first-stk[k].first);
