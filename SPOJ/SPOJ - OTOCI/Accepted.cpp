/****************************************************************************************
*  @author: kzvd4729                                         created: 2020-09-30 18:58:52                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time (ms): 2360                                       memory_used (MB): 4.8                             
*  problem: https://vjudge.net/problem/SPOJ-OTOCI
****************************************************************************************/
#include<iostream>
#include<vector>
#include<cstring>
...
struct node
{
  ...
  int dt,sm;//value of the node and sum of subtree(in splay)
...
int main()
{
  ...
  while(q--)
  {
    ...
    else if(s[0]=='p')
    {
      ...
      update(v,v,x-a[v]);a[v]=x;
    }
    else
    {
      int a,b;scanf("%d%d",&a,&b);
      if(isConnected(a,b))printf("%d\n",query(a,b));
