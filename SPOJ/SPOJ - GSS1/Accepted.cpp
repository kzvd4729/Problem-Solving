/****************************************************************************************
*  @author: kzvd4729                                         created: 2018-03-29 23:42:00                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time (ms): 410                                        memory_used (MB): 22.5                            
...
void build(long node,long lo,long hi)
{
  ...
  seg[node].mx=max(seg[node].mx,seg[node*2].rgt+seg[node*2+1].lft);
}
