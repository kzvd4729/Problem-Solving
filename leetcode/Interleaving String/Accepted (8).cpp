/****************************************************************************************
*  @author: kzvd4729                                         created: 06/02/2021 21:38                         
*  solution_verdict: Accepted                                language: cpp                                     
*  run_time: 580 ms                                          memory_used: 39.1 MB                              
*  problem: https://leetcode.com/problems/interleaving-string
****************************************************************************************/
string a,b,c;
int dp[100+2][100+2][200+2][2][2];
bool dfs(int i,int j,int k,int tr,int f)
{
  if(k==(int)c.size())return true;
  if(dp[i][j][k][tr][f]!=-1)return dp[i][j][k][tr][f];
    bool ret=false;
