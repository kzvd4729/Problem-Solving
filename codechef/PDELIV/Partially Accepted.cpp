/****************************************************************************************
*  @author: kzvd4729                                         created: 19-07-2019 13:58:58                      
*  solution_verdict: Partially Accepted                      language: C++14                                   
*  run_time: 1.47 sec                                        memory_used: 293.4M                               
...
void add(long node,long lo,long hi,long id,long m,long b)
{
  seg[node].add(m,b);
  if(lo==hi)return ;
  long md=(lo+hi)/2;
...
long get(long node,long lo,long hi,long lt,long rt,long x)
{
