/****************************************************************************************
*  @author: kzvd4729                                         created: 09-11-2017 14:43:56                      
...
void upd(long node,long lo,long hi,long idx,long val)
{
    ...
    long x,y,xx,yy;
    if(seg[node*2].trt==0||seg[node*2].trt<seg[node*2].frt)x=0;
    ...
    if(seg[node*2+1].tlt==0||seg[node*2+1].tlt>seg[node*2+1].flt)y=0;
