/****************************************************************************************
*  @author: kzvd4729                                         created: 06-03-2019 19:53:49                      
*  solution_verdict: Accepted                                language: C++14                                   
*  run_time: 1.77 sec                                        memory_used: 1946M                                
...
/////////////////////////////////////////
int n,k,sz[N+2],nxt[20][N+2],dp[5001][N+1];
...
int main()
{
  ...
  for(int i=0;i<(1<<k);i++)
    mp[i].max_load_factor(0.25),mp[i].reserve(1024);
