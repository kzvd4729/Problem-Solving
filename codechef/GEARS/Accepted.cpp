/****************************************************************************************
*  @author: kzvd4729                                         created: 16-07-2018 00:01:20                      
*  solution_verdict: Accepted                                language: C++14                                   
*  run_time: 0.13 sec                                        memory_used: 19.5M                                
  ...
  while(m--)
  {
    ...
    else
    {
      ...
      else
      {
        ...
        if(pa.second==pb.second)cout<<tmp/gcd<<"/"<<arr[v]/gcd<<"\n";
        else cout<<-(tmp/gcd)<<"/"<<arr[v]/gcd<<"\n";
      }
    }
  }
  return 0;
