/****************************************************************************************
*  @author: kzvd4729                                         created: 06-10-2017 23:57:18                      
*  solution_verdict: Partially Accepted                      language: C++14                                   
*  run_time: 0.04 sec                                        memory_used: 15.2M                                
...
void case1(void)
{
    ...
    while(true)
    {
        if(!ga)for(long i=1;i<=b;i++)ans.push_back('b');
        else if(b>=(ga-1)+y&&ga)
        {
...
void case2(void)
{
    ...
    while(true)
    {
        if(!gb)for(long i=1;i<=a;i++)ans.push_back('a');
        else if(a>=(gb-1)+x&&gb)
        {
            for(long i=1; i<=x; i++)ans.push_back('a');
            a-=x;
