/****************************************************************************************
*  @author: kzvd4729                                         created: 25-07-2019 09:24:18                      
*  solution_verdict: Partially Accepted                      language: C++14                                   
*  run_time: 0.58 sec                                        memory_used: 81.5M                                
...
{
  sort(v.begin(),v.end());
  vector<point>hull;long n=v.size();
...
long a,b;long pr[N+2];
long rotatingCalipers(vector<point>&p)
{
  long n=p.size(),j=1;long ans=0;
  for(long i=0;i<n;i++)
  {
