/****************************************************************************************
*  @author: kzvd4729                                         created: 08-11-2018 22:26:35                      
*  solution_verdict: Accepted                                language: C++14                                   
*  run_time: 0.16 sec                                        memory_used: 34.1M                                
...
int main()
{
  ...
  while(av.size())
  {
    ...
    for(auto x:sb)
    {
      if(!vis[x.second+p.second]||!vis[sum-x.second+p.second])
      {
        sb.erase(x);f=1;
