/****************************************************************************************
*  @author: kzvd4729                                         created: 05-09-2017 23:32:05                      
*  solution_verdict: Partially Accepted                      language: C++14                                   
*  run_time: 0.22 sec                                        memory_used: 46.2M                                
...
#define M 1000000007
using namespace std;
long t,n,m,seg[500004],lazy[500004],ans[500005],id,seg2[500004],lazy2[500004];
struct data
{
    long ty;
    long lf;
...
long que(long node,long lo,long hi,long l,long r)
{
    ...
    long mid=(lo+hi)/2;
    long p1=que(node*2,lo,mid,l,r)%M;
    long p2=que(node*2+1,mid+1,hi,l,r)%M;
    return (p1+p2)%M;
}
