/****************************************************************************************
*  @author: kzvd4729                                         created: 14-12-2018 21:55:25                      
*  solution_verdict: Accepted                                language: C++14                                   
*  run_time: 0.67 sec                                        memory_used: 117M                                 
...
int main()
{
  ...
  while(true)
  {
    ...
    else
    {
      ...
      if(avl.size()==1)
      {
        ans.push_back({1,avl.begin()->second});
        del(avl.begin()->second);
      }
      else
      {
        int a=avl.begin()->second;avl.erase({in[a],a});
        int b=avl.begin()->second;avl.insert({in[a],a});
        del(a);del(b);ans.push_back({2,a,b});
      }
    }
  }
