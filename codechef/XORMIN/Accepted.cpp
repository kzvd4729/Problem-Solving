/****************************************************************************************
*  @author: kzvd4729                                         created: 12-04-2019 00:21:00                      
*  solution_verdict: Accepted                                language: C++14                                   
*  run_time: 1.78 sec                                        memory_used: 451.1M                               
*  problem: https://www.codechef.com/APRIL19A/problems/XORMIN
****************************************************************************************/
#include<bits/stdc++.h>
#define long long long
using namespace std;
const int N=4e6,cnt=2;
...
int main()
{
  ...
  while(t--)
  {
    ...
    while(q--)
    {
      ...
      vr=query((vl^k),1,1,bse[(vl^k)].size(),ent[v],ext[v]);
      cout<<vr<<" "<<vl<<"\n";
    }
    for(auto x:tmp)
