/****************************************************************************************
*  @author: kzvd4729                                         created: 11-04-2019 22:59:42                      
*  solution_verdict: Partially Accepted                      language: C++14                                   
*  run_time: 0.63 sec                                        memory_used: 786.5M                               
*  problem: https://www.codechef.com/APRIL19A/problems/XORMIN
****************************************************************************************/
#include<bits/stdc++.h>
#define long long long
using namespace std;
const int N=8e6,cnt=2;
int ww[N+2],tim,ent[N+2],ext[N+2],sz;
int rt[N+2],tr[200000*30+2][3],rev[N+2];
...
int qry(int x,int on,int tw)
{
  ...
  {
    bool z=(x&(1<<i));
    if(tr[tr[tw][z^1]][cnt]-tr[tr[on][z^1]][cnt]<0)assert(0);
