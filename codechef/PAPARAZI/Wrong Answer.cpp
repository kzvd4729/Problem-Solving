/****************************************************************************************
*  @author: kzvd4729                                         created: 09-03-2021 21:54:03                      
*  solution_verdict: Wrong Answer                            language: C++17                                   
*  run_time: 0.00 sec                                        memory_used: 6M                                   
...
int main()
{
  ...
  while(t--)
  {
    ...
    for(int i=0;i<n;i++)
    {
      ...
      ans=max(ans,mp[{p[i].x,p[i].y}]-mp[{p[j].x,p[j].y}]);
    }
    cout<<ans<<'\n';
  }
  return 0;
