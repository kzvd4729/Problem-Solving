/****************************************************************************************
*  @author: kzvd4729                                         created: Jun/15/2020 18:31                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 888 ms                                          memory_used: 88100 KB                             
...
int main()
{
  ...
  for(int i=1;i<=m;i++)
  {
    int u,v;cin>>u>>v;int a=get(u),b=get(v);if(a!=b)par[a]=b;
   ...
   for(auto x:ed)
  {
    ...
    adj[com[x.first]].push_back(com[x.second]);adj[com[x.second]].push_back(com[x.first]);
  }
  for(int i=1;i<=cnt;i++)
  ...
  for(int i=1;i<=cnt;i++)sp[i][0]=inf,an[i][0]=-inf;
  for(int i=1;i<=q;i++)
  {
