/****************************************************************************************
*  @author: kzvd4729                                         created: Aug/31/2018 20:39                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 920 ms                                          memory_used: 28500 KB                             
...
void query(int v,int rt)
{
  ...
  if(par[rt]==v)cout<<query(1,1,n,1,n)-query(1,1,n,st[rt],ed[rt])<<endl;
  else cout<<query(1,1,n,st[v],ed[v])<<endl;
}
int main()
{
