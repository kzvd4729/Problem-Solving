/****************************************************************************************
*  @author: kzvd4729                                         created: Aug/02/2018 14:58                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 280 ms                                          memory_used: 98200 KB                             
...
long dfs(int ii,int now,int f1,int f2,int mt)
{
  ...
  if(dp[ii][now][f1][f2][mt]!=-1)return dp[ii][now][f1][f2][mt];
  int lo=a[ii]-'0';
  int hi=b[ii]-'0';
   if(f1)lo=0;
  if(f2)hi=9;
  ...
  return dp[ii][now][f1][f2][mt]=here;
}
int main()
{
