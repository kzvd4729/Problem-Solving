/****************************************************************************************
*  @author: kzvd4729                                         created: Jun/11/2020 13:42                        
*  solution_verdict: Time limit exceeded on test 1           language: GNU C++14                               
*  run_time: 3000 ms                                         memory_used: 142900 KB                            
...
int main()
{
  ...
  while(m--)
  {
    int l,r,k;l=readInt(),r=readInt(),k=readInt();//cout<<l<<" "<<r<<" "<<k<<endl;
    cout<<get(rot[rt[k]],rot[lt[k]-1],0,v.size()-1,bg[l],bg[r]+a[r].size()-1)<<" ";
  }
  //cout<<endl;
  return 0;
}