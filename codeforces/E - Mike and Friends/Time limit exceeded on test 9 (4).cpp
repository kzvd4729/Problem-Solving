/****************************************************************************************
*  @author: kzvd4729                                         created: Jun/11/2020 13:26                        
*  solution_verdict: Time limit exceeded on test 9           language: GNU C++11                               
*  run_time: 3000 ms                                         memory_used: 142500 KB                            
...
int main()
{
  ...
  while(m--)
  {
    int l,r,k;cin>>l>>r>>k;int id=po[bg[k]];
    int lo=0,hi=id,md;
    while(hi-lo>2)
    {
      md=(lo+hi)/2;
