/****************************************************************************************
*  @author: kzvd4729                                         created: Apr/06/2021 22:31                        
*  solution_verdict: Accepted                                language: GNU C++17 (64)                          
*  run_time: 670 ms                                          memory_used: 80500 KB                             
  ...
  int main()
{
  ...
  while(t--)
  {
     ...
     for(int i=1;i<=n;i++)
    {
      ...
      if(cv>=r){prn=max(prn,ans);continue;}
        int cr=-1;
      if(cv>=l)cr++,cv++;
      else cv=l+1;
        while(cv<=r)
