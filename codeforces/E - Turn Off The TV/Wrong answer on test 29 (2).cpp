/****************************************************************************************
*  @author: kzvd4729                                         created: Jul/25/2018 22:38                        
*  solution_verdict: Wrong answer on test 29                 language: GNU C++17                               
...
void upd(int node,int lo,int hi,int lt,int rt)
{
  ...
  seg[node].sum=min(seg[seg[node].l].sum,seg[seg[node].r].sum);
}
