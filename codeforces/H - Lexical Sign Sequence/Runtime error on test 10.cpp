/****************************************************************************************
*  @author: kzvd4729                                         created: Nov/30/2019 13:09                        
*  solution_verdict: Runtime error on test 10                language: GNU C++14                               
*  run_time: 15 ms                                           memory_used: 6700 KB                              
...
int main()
{
  ...
  for(int i=1;i<=m;i++)
  {
    if(qm[rt[i]]-qm[lt[i]-1]<sm[i])assert(0);
  }
