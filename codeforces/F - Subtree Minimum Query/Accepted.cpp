/****************************************************************************************
*  @author: kzvd4729                                         created: Jul/23/2018 23:11                        
*  solution_verdict: Accepted                                language: GNU C++17                               
*  run_time: 4133 ms                                         memory_used: 36800 KB                             
...
const int inf=1e9;
const int N=1e5;
int n,q,bt[N+2],hg[N+2],arr[N+2],k,r;
...
int main()
{
  ...
  build(1,1,n);
 //  cout<<endl;
//  for(int i=0;i<seg[5].size();i++)
//  {
//    cout<<seg[5][i].first<<" "<<seg[5][i].second<<endl;
//  }
//  cout<<endl;
 //  cout<<"goes here "<<endl;
