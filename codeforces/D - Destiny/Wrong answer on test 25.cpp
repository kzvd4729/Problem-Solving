/****************************************************************************************
*  @author: kzvd4729                                         created: May/30/2021 15:26                        
*  solution_verdict: Wrong answer on test 25                 language: GNU C++17 (64)                          
*  run_time: 2262 ms                                         memory_used: 12100 KB                             
 ...
 int main()
{
   ...
   while(q--)
  {
    ...
    int th=50,ans=inf;
    vector<int>u;
    while(th--)u.push_back(a[l+rng()%(r-l+1)]);
     sort(u.begin(),u.end());
