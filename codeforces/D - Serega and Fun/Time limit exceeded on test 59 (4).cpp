/****************************************************************************************
*  @author: kzvd4729                                         created: Oct/03/2018 01:16                        
*  solution_verdict: Time limit exceeded on test 59          language: GNU C++14                               
*  run_time: 4000 ms                                         memory_used: 158200 KB                            
*  problem: https://codeforces.com/contest/455/problem/D
****************************************************************************************/
#include<bits/stdc++.h>
#define long long long
using namespace std;
const int N=1e5,sq=4e2;
int fr[sq+2][N+2],tmp;
deque<int>dq[sq+2];
