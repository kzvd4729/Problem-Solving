/****************************************************************************************
*  @author: kzvd4729                                         created: Mar/28/2018 23:36                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 451 ms                                          memory_used: 4000 KB                              
...
//  2 for 2 blocked;
//  3 for 3 blocked;
//  4 for first two blocked;
//  5 for first and last blocked;
//  6 for last two blocked;
//  7 for all blocked;
  matrix base;
  if(wh==4)
  {
...
//  2 for 2 empty;
//  3 for 3 empty;
//  4 for first two empty;
//  5 for first and last empty;
//  6 for last two empty;
//  7 for all empty;
  for(int i=1;i<=id;i++)
  {
    matrix ans;
    ...
    if(cnb)inb=0LL;
    if(cnc)inc=0LL;
    ///cout<<"here "<<now<<" "<<ina<<" "<<inb<<" "<<inc<<endl;
   }
  cout<<inb<<endl;
  return 0;
}