/****************************************************************************************
*  @author: kzvd4729                                         created: Sep/29/2020 14:41                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 576 ms                                          memory_used: 5100 KB                              
*  problem: https://codeforces.com/gym/101554/problem/D
****************************************************************************************/
#include<iostream>
#include<vector>
#include<cstring>
...
int main()  
{
  ...
  for(int i=0;i<n;i++)cin>>v[i].x>>v[i].y;
   polygon p;p.p=v;
  p.convexHull();cout<<p.rotateCalipers()<<endl;
   return 0;
}