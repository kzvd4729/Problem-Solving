/****************************************************************************************
*  @author: kzvd4729                                         created: Aug/11/2018 21:33                        
*  solution_verdict: Memory limit exceeded on pretest 4      language: GNU C++14                               
*  run_time: 171 ms                                          memory_used: 262100 KB                            
...
void divide(int lo,int hi)
{
  ...
  {
    if(lo!=hi)divide(lo,md1);
  }
  else
  {
    if(lo!=hi)divide(md1,hi);
  }
 }
int main()
{
