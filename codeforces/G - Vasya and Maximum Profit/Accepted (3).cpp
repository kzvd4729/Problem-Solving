/****************************************************************************************
*  @author: kzvd4729                                         created: Jan/27/2019 18:54                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 514 ms                                          memory_used: 95100 KB                             
...
int main()
{
  ...
  /*for(int i=1;i<=n;i++)
    cout<<cc[i]<<" ";
  cout<<endl;*/
  Sparse_Min_Build(n);Build_Max_Sum(1,1,n);
  ...
  for(int i=2;i<=n;i++)
  {
    ...
    lt=md-1;
    ans=max(ans,Qry_Max_Sum(1,1,n,lt,rt).mx-SP[i]);
  }
  cout<<ans<<endl;
  return 0;
}