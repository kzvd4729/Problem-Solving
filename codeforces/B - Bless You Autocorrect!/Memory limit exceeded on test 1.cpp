/****************************************************************************************
*  @author: JU_Quanta: tariqiitju, mh755628, kzvd4729#       created: Oct/09/2019 19:40                        
*  solution_verdict: Memory limit exceeded on test 1         language: GNU C++14                               
*  run_time: 109 ms                                          memory_used: 262100 KB                            
...
int match(int i)
{
  int lo=0,hi=min((int)tmp.s.size(),(int)hs[i].s.size()),md;
  while(hi-lo>2)
  {
    md=(lo+hi)/2;
