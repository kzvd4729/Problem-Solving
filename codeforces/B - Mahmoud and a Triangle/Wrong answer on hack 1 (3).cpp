/****************************************************************************************
*  @author: kzvd4729                                         created: Feb/08/2017 00:58                        
*  solution_verdict: Wrong answer on hack 1                  language: GNU C++11                               
*  run_time: 265 ms                                          memory_used: 9800 KB                              
...
int main()
{
    long long int n,arr[1000000],i,x,y,z;
    while(cin>>n)
    {
        for(i=0; i<n; i++)
        {
        ...
        for(i=n-1; i>=0; i--)
        {
            ...
            if(arr[i]>0&&y==0&&x!=0&&z==0)
            {
                y=arr[i];
                arr[i]=0;
                //cout<<y<<endl;
             }
            if(arr[i]>0&&x==0&&y==0&&z==0)
            {
                x=arr[i];
                arr[i]=0;
                //cout<<x<<endl;
