/****************************************************************************************
*  @author: * kzvd4729                                       created: Jan/08/2021 22:28                        
*  solution_verdict: Wrong answer on pretest 5               language: GNU C++14                               
*  run_time: 46 ms                                           memory_used: 78500 KB                             
...
vector<int>ad[N+2];
int tim,ent[N+2],ext[N+2],ch[N+2],ln[N+2],par[N+2],vs[N+2];
...
int main()
{
  ...
  for(int i=1;i<=n;i++)cnt+=((get(i)==0)&&vs[ln[i]]==0);
   cout<<cnt<<endl;
   return 0;
}