/****************************************************************************************
*  @author: kzvd4729                                         created: Mar/03/2021 18:24                        
*  solution_verdict: Wrong answer on test 14                 language: GNU C++14                               
*  run_time: 249 ms                                          memory_used: 46900 KB                             
 ...
 void reckon(int nd,int pr)
{
  ...
  for(int i=0;i<sz;i++)
  {
    int x=ad[nd][i],id=nm[nd][i];
    if(x==pr||vs[id])continue;
