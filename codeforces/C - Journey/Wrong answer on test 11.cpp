/****************************************************************************************
*  @author: kzvd4729                                         created: Sep/12/2018 02:11                        
*  solution_verdict: Wrong answer on test 11                 language: GNU C++14                               
*  run_time: 1980 ms                                         memory_used: 700 KB                               
...
{
  if(clock()>2000)cout<<1<<endl,exit(0);
  if(c>t)return ;
  if(node==n)
  {
    mx=max(mx,ans);
...
{
  if(clock()>2000)cout<<2<<endl,exit(0);
  if(c>t)return ;
  if(node==n)
  {
    if(ans==mx)f=1;
...
int main()
{
  ...
  if(clock()>2000)cout<<3<<endl,exit(0);
  cout<<1<<" ";
  for(auto x:pr)
    cout<<x<<" ";
  cout<<endl;
