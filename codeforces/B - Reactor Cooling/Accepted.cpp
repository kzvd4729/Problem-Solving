/****************************************************************************************
*  @author: kzvd4729                                         created: Jan/18/2020 22:43                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 62 ms                                           memory_used: 31300 KB                             
*  problem: https://codeforces.com/gym/100199/problem/B
****************************************************************************************/
#include<bits/stdc++.h>
...
int main()
{
  ...
  int n,m;cin>>n>>m;sn=n+1;int sm=0;
  for(int i=1;i<=m;i++)
  {
    int a,b,c,d;cin>>a>>b>>c>>d;sm+=c;
    no[i]=ed.size();mn[i]=c;
    addEdge(a,b,d-c);addEdge(sr,b,c);addEdge(a,sn,c);
  }
  if(sm!=dinic())cout<<"NO\n",exit(0);
  cout<<"YES\n";
  for(int i=1;i<=m;i++)
