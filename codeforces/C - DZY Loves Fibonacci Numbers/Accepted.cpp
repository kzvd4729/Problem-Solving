/****************************************************************************************
*  @author: kzvd4729                                         created: Jun/05/2020 18:58                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 950 ms                                          memory_used: 37800 KB                             
...
int compute(int a,int b,long p)//v is a column vector
{
  return (1LL*a*power[p-1][0][0]+1LL*b*power[p-1][0][1])%mod;
