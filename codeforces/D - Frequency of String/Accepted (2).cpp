/****************************************************************************************
*  @author: kzvd4729                                         created: Aug/28/2019 16:40                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 670 ms                                          memory_used: 19900 KB                             
...
int main()
{
  ...
  for(int i=1;i<=n;i++)
  {
    ...
    for(int j=0;j+kk[i]-1<pos.size();j++)
      mn=min(mn,pos[j+kk[i]-1]-pos[j]);
    cout<<mn+len<<"\n";
  }
  return 0;
}