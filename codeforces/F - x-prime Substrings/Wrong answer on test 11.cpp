/****************************************************************************************
*  @author: kzvd4729                                         created: Aug/29/2020 18:45                        
*  solution_verdict: Wrong answer on test 11                 language: GNU C++17                               
*  run_time: 31 ms                                           memory_used: 7000 KB                              
...
using namespace std;
const int N=1e3;
string s;int x,n,dp[N+2][10+2][10+2][10+2];
int dfs(int i,int a,int b,int c)
{
  if(i==n)return 0;
  if(a>b)swap(a,b);if(a>c)swap(a,c);if(b>c)swap(b,c);
  int aa=min(10,a-i),bb=min(10,b-i),cc=min(10,c-i);
