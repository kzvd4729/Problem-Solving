/****************************************************************************************
*  @author: kzvd4729                                         created: Oct/27/2019 19:59                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 296 ms                                          memory_used: 34200 KB                             
...
//    cout<<endl;
    ...
    for(int i=1;i<rt.size();i++)
    {
      ...
      if(deg[uu[nm]]==1)
      {
        cout<<rv[uu[nm]]<<" "<<rv[rt[i-1]]<<"\n";
        if(rt[i]==uu[nm])rt[i]=vv[nm];
      }
      else
      {
        cout<<rv[vv[nm]]<<" "<<rv[rt[i-1]]<<"\n";
        if(rt[i]==vv[nm])rt[i]=uu[nm];
      }
    }
  }
  return 0;
