/****************************************************************************************
*  @author: kzvd4729                                         created: Nov/16/2020 23:24                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 265 ms                                          memory_used: 24900 KB                             
...
int main()
{
  ...
  {
    //cout<<l[i]<<" "<<r[i]<<endl;
    if(l[i]<=lo&&r[i]>=hi&&m[i]>=lo&&m[i]<=hi){cnt++;cout<<i+1<<" ";}
  }
  assert(cnt==ans);cout<<endl;
  return 0;
}