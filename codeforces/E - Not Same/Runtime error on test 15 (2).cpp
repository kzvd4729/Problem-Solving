/****************************************************************************************
*  @author: kzvd4729                                         created: Jul/04/2020 18:45                        
*  solution_verdict: Runtime error on test 15                language: GNU C++17                               
*  run_time: 93 ms                                           memory_used: 200 KB                               
...
int main()
{
   ...
   for(int i=0;i<mx-1;i++)
  {
    for(int j=0;j<n;j++)
    {
      if(bt[i][j]!=bt[mx-1][j])
      {
        bt[i][j]=!bt[i][j];bt[mx-1][j]=!bt[mx-1][j];
        //print();
