/****************************************************************************************
*  @author: kzvd4729                                         created: Aug/01/2020 13:33                        
*  solution_verdict: Runtime error on test 6                 language: GNU C++14                               
*  run_time: 15 ms                                           memory_used: 8500 KB                              
...
int main()
{
  ...
  for(int i=2;i<=n;i++)
  {
    ans=min(ans,ck(point(a[1].x1,a[1].y)-point(a[i].x1,a[i].y)));
    ans=min(ans,ck(point(a[1].x1,a[1].y)-point(a[i].x2,a[i].y)));
    ans=min(ans,ck(point(a[1].x2,a[1].y)-point(a[i].x1,a[i].y)));
    ans=min(ans,ck(point(a[1].x2,a[1].y)-point(a[i].x2,a[i].y)));
  }
  assert(ans<1e10);
