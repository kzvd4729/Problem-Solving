/****************************************************************************************
*  @author: kzvd4729                                         created: Oct/08/2018 16:54                        
...
//  cout<<endl;
//  for(auto x:nn)cout<<x<<" ";
//  cout<<endl;
  if(n==500)cout<<pr.size()<<"----"<<nn.size()<<endl;
  for(auto x:pr)mp1[x]++;
  for(auto x:nn)if(x>1)mp2[x]++;
  long ans=1;
  for(auto x:mp1)ans*=(x.second+1);
  for(auto x:mp2)ans*=(x.second+1)*(x.second+1);
