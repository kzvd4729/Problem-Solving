/****************************************************************************************
*  @author: kzvd4729                                         created: May/04/2020 14:00                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 623 ms                                          memory_used: 40600 KB                             
...
int aa[N+2],bb[N+2];unordered_map<int,long>bit;
...
int main()
{
  ...
  for(auto x:v)
  {
    ...
    ans+=1LL*get(mp[x.first]+1)*x.second;
    upd(mp[x.first]+1,x.second);
  }
  cout<<ans<<endl;
  return 0;
}