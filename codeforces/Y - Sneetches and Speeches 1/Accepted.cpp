/****************************************************************************************
*  @author: kzvd4729                                         created: Nov/01/2020 20:24                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 483 ms                                          memory_used: 43300 KB                             
...
{
  tooLazy(node);tooLazy(bst[node].lt);tooLazy(bst[node].rt);
...
{
  tooLazy(lt);tooLazy(rt);tooLazy(bst[lt].lt);tooLazy(bst[lt].rt);
