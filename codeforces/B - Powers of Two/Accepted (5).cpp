/****************************************************************************************
*  @author: kzvd4729                                         created: Apr/16/2019 18:30                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 686 ms                                          memory_used: 144700 KB                            
...
typedef cc_hash_table<
    long long, long long, hash<long long>, equal_to<long long>, direct_mask_range_hashing<long long>,
...
int main()
{
  ...
  //mp.max_load_factor(0.25);mp.reserve(1024);
