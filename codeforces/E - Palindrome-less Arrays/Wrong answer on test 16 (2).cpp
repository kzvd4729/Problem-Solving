/****************************************************************************************
*  @author: kzvd4729                                         created: Jun/06/2020 13:44                        
*  solution_verdict: Wrong answer on test 16                 language: GNU C++14                               
*  run_time: 62 ms                                           memory_used: 19300 KB                             
...
long k,dp1[N+2][2],sz,dp2[N+2][2][2],dp[100+2][100+2][100+2],aa[N+2],n;
 ...
 int main()
{
  ...
  if(n<=100&&k<=100)cout<<dfs(1,0,0)<<endl,exit(0);
