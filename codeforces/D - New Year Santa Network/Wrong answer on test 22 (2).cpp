/****************************************************************************************
*  @author: kzvd4729                                         created: Aug/22/2018 10:27                        
*  solution_verdict: Wrong answer on test 22                 language: GNU C++14                               
*  run_time: 716 ms                                          memory_used: 13500 KB                             
...
const int N=1e5;
vector<int>adj[N+2];
long long n,tt,dn,sz[N+2],cs[N+2],hw[N+2];
...
int main()
{
 ...
 while(q--)
 {
  ...
  tt+=cs[id]*hw[id];
  long double ttt=tt,ddn=dn;
  long double pr=ttt/ddn;
