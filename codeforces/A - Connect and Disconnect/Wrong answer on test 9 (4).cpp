/****************************************************************************************
*  @author: kzvd4729                                         created: Oct/10/2019 19:49                        
...
int main()
{
  ...
  for(int bl=0; ;bl++)
  {
    ...
    //for(int i=1;i<=n;i++)if(par2[i]!=i)assert(0);
    for(int i=l;i<=r;i++)
    {
      ...
      for(auto &x:tmp)
      {
        ...
        {
          onl.push_back(x);
          //int r=get(x[0]);par2[x[0]]=r;//if(par2[r]!=r)assert(0);//par2[r]=r;
          //r=get(x[1]);par2[x[1]]=r;//if(par2[r]!=r)assert(0);//par2[r]=r;
          if(get(x[0])==get(x[1]))continue;
