/****************************************************************************************
*  @author: kzvd4729                                         created: Nov/26/2019 21:32                        
*  solution_verdict: Wrong answer on test 1                  language: GNU C++14                               
*  run_time: 30 ms                                           memory_used: 82200 KB                             
...
vector<int>multiply(vector<int>p,vector<int>q)
{
 vector<int>c1=multiply(p,q,3,469762049);
  ...
  vector<int>c3=multiply(p,q,10,786432);
  m[1]=469762049,m[2]=1004535809,m[3]=786432;
  vector<int>c4;
  for(int i=0;i<c1.size();i++)
  {
   a[1]=c1[i],a[2]=c2[i],a[3]=c3[i];
   //cout<<c1[i]<<" "<<c2[i]<<" "<<crt(2,998244353)<<endl;
   c4.push_back(crt(3,998244353));
  }
  return c4;
}
int cnt[N+2];
