/****************************************************************************************
*  @author: JU_Troubleshooer: tariqiitju, the0dd1out, kzvd4729 created: Oct/20/2018 17:39                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 608 ms                                          memory_used: 32000 KB                             
 ...
 int main()
{
  ...
  if(posi)
 {
  ...
  {
   pf("%u.%u.%u.%u/%d\n",(bl[i]>>24)&255,
   (bl[i]>>16)&255,(bl[i]>>8)&255,bl[i]&255,
   sm[i] );
  }
 }else cout<<-1<<endl;
    return 0;
