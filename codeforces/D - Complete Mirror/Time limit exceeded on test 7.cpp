/****************************************************************************************
*  @author: kzvd4729                                         created: Jul/15/2020 18:59                        
*  solution_verdict: Time limit exceeded on test 7           language: GNU C++17                               
*  run_time: 1000 ms                                         memory_used: 60200 KB                             
...
void dds(int node,int par,int sz)
{
  //cout<<node<<" ** "<<sz<<endl;
  int f=1;
  for(auto x:adj[node])
