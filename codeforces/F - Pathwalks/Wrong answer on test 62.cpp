/****************************************************************************************
*  @author: kzvd4729                                         created: Apr/08/2018 23:56                        
*  solution_verdict: Wrong answer on test 62                 language: GNU C++14                               
*  run_time: 514 ms                                          memory_used: 79600 KB                             
...
int main()
{
  ...
  for(int i=1;i<=n;i++)print=max(print,query(i,100003));
  cout<<print<<endl;
  return 0;
}