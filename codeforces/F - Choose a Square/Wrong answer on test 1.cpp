/****************************************************************************************
*  @author: kzvd4729                                         created: Dec/10/2020 23:24                        
...
int main()
{
  ...
  for(auto x:mp)
  {
    ...
    if(p>ans)ans=p,bg=x.first+1;
   }
  if(ans.first<=0)cout<<0<<" "<<inf+1<<" "<<inf+1<<" "<<inf+2<<" "<<inf+2<<endl;
  else cout<<ans.first<<" "<<bg<<" "<<bg<<" "<<ans.second-bg<<" "<<ans.second-bg<<endl;
  return 0;
}