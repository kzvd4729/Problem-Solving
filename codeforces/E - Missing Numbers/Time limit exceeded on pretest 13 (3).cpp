/****************************************************************************************
*  @author: kzvd4729                                         created: Dec/16/2018 23:04                        
*  solution_verdict: Time limit exceeded on pretest 13       language: GNU C++14                               
*  run_time: 2000 ms                                         memory_used: 17600 KB                             
...
using namespace std;
const int N=2e5;
int aa[N+2],dis[N+2],mx,par[N+2],vis[N+2];
