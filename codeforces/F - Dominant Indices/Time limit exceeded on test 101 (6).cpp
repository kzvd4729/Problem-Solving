/****************************************************************************************
*  @author: kzvd4729                                         created: Aug/08/2018 00:38                        
*  solution_verdict: Time limit exceeded on test 101         language: GNU C++14                               
...
using namespace std;
const int N=1e6;
int n,u,v,ans[N+2],tmp[N+2],mxx,st[N+2],tim;
