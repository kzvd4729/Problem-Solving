/****************************************************************************************
*  @author: kzvd4729                                         created: Dec/04/2019 16:38                        
*  solution_verdict: Wrong answer on test 5                  language: GNU C++14                               
*  run_time: 30 ms                                           memory_used: 4300 KB                              
*  problem: https://codeforces.com/contest/1045/problem/B
****************************************************************************************/
#include<bits/stdc++.h>
...
int main()
{
  ios_base::sync_with_stdio(0);cin.tie(0);
   int n,m;cin>>n>>m;if(m>400000)cout<<0<<endl,exit(0);
   vector<int>a(m),b(m);for(int i=0;i<m;i++)b[i]=1;
  for(int i=1;i<=n;i++)
  {
    int x;cin>>x;a[x]=1,b[x]=0;
  }
