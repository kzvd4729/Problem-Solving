/****************************************************************************************
*  @author: kzvd4729                                         created: Feb/03/2021 16:52                        
*  solution_verdict: Runtime error on test 2                 language: GNU C++14                               
*  run_time: 31 ms                                           memory_used: 39500 KB                             
...
int a[N+2],blNo[N+2],p[N+2],vl[N+2],fr[N+2],frfr[N+2],ans[N+2];
