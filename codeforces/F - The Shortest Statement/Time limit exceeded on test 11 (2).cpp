/****************************************************************************************
*  @author: kzvd4729                                         created: Jul/08/2019 14:24                        
*  solution_verdict: Time limit exceeded on test 11          language: GNU C++14                               
*  run_time: 4000 ms                                         memory_used: 30200 KB                             
...
int main()
{
  ...
  while(q--)
  {
    ...
    for(auto x:un)
    {
      if(dist(x.second.first,x.second.second)<=x.first)continue;
