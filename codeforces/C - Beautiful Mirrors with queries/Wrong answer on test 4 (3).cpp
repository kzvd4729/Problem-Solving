/****************************************************************************************
*  @author: kzvd4729                                         created: Jul/27/2020 21:15                        
*  solution_verdict: Wrong answer on test 4                  language: GNU C++17                               
*  run_time: 810 ms                                          memory_used: 22200 KB                             
...
int bit[N+2];
void upd(int x,int vl){vl%=mod;for( ;x<=N;x+=x&-x)bit[x]=(bit[x]+vl)%mod;}
