/****************************************************************************************
*  @author: kzvd4729                                         created: Aug/01/2017 19:38                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 2370 ms                                         memory_used: 10500 KB                             
*  problem: https://codeforces.com/contest/52/problem/C
****************************************************************************************/
#include<bits/stdc++.h>
using namespace std;
int arr[200002],seg[1000003],lazy[1000003],lr[30],id,q,n;
string s;
...
int main()
{
    ...
    while(q--)
    {
        ...
        else
        {
            ...
            {
                int p1=query(1,0,n-1,lr[1],n-1);
                int p2=query(1,0,n-1,0,lr[2]);
                cout<<min(p1,p2)<<endl;
            }
        }
    }
