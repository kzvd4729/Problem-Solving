/****************************************************************************************
*  @author: kzvd4729                                         created: Mar/01/2020 04:02                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 3400 ms                                         memory_used: 679000 KB                            
...
int main()
{
  ...
  if(k<=1800)cout<<dfs(0,0,ss.size()-1)<<endl,exit(0);
  for(int i=1;i<=1800;i++)
  {
    p=ss.size()+i;
    //if(i<=5)cout<<dfs(0,0,ss.size()-1)<<endl;
    v.push_back(dfs(0,0,ss.size()-1));
  }
  work(v);cout<<calc(k-1)<<endl;
  return 0;
}