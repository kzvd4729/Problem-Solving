/****************************************************************************************
*  @author: kzvd4729                                         created: Apr/04/2018 13:21                        
*  solution_verdict: Wrong answer on test 49                 language: GNU C++17                               
*  run_time: 217 ms                                          memory_used: 45100 KB                             
...
void factorize(void)
{
  ...
  for(int i=0;i<pr.size();i++)if(pr[i]>100000)fc[pr[i]].push_back(pr[i]);
}
void kato(int x)
{
