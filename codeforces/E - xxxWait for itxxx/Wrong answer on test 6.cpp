...
void supd(long node,long lo,long hi,long id,long vl)
{
  ...
  long md=(lo+hi)/2;
  if(id<=md)supd(node*2,lo,md,id,vl);
  else supd(node*2+1,md+1,hi,id,vl);
