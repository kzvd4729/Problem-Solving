/****************************************************************************************
*  @author: kzvd4729                                         created: Jun/17/2019 17:00                        
*  solution_verdict: Time limit exceeded on test 4           language: GNU C++14                               
*  run_time: 2000 ms                                         memory_used: 17900 KB                             
...
vector<int>adj[N+2],ex[N+2],ok[N+2];
...
int main()
{
  ...
  int cnt=0;
  cout<<"d "<<1<<endl;int ds;cin>>ds;cnt++;
  int node=1;
  while(true)
  {
    int lf=leaf[node];
