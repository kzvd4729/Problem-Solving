/****************************************************************************************
*  @author: kzvd4729                                         created: Aug/25/2019 12:45                        
*  solution_verdict: Accepted                                language: GNU C++14                               
*  run_time: 420 ms                                          memory_used: 54800 KB                             
...
int main()
{
  ...
  while(t--)
  {
    string a;cin>>a;aa.constructor(a.size()+2);
    aa.build(a);aa.occurrences();
     string b;cin>>b;bb.constructor(b.size()+2);
