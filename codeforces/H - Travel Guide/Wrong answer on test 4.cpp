/****************************************************************************************
*  @author: kzvd4729                                         created: Jan/10/2020 16:34                        
*  solution_verdict: Wrong answer on test 4                  language: GNU C++14                               
*  run_time: 15 ms                                           memory_used: 63000 KB                             
...
vector<vector<int> >simplify(vector<vector<int> >v)
{
  ...
  for(int i=1;i<v.size();i++)
  {
    ...
    else
    {
      ...
      for(auto x:tmp)
      {
        if(x.second>mn)continue;
        mn=x.second;u.push_back({v[i-1][0],x.first,x.second});
      }
      tmp.clear();tmp.push_back({v[i][1],v[i][2]});
    }
  }
  sort(u.begin(),u.end());return u;
}
 //..............................................................
int tr;
struct treap
