/****************************************************************************************
*  @author: kzvd4729                                         created: 2019-05-18 22:40:04                      
...
vector<line>l;
void halfPlaneIntersection(vector<point>&poly)
{
...
int main()
{
  ...
  while(t--)
  {
    ...
    for(int i=0;i<n;i++)
      l[i]=line(p[i],p[i+1]);
    vector<point>poly;
    halfPlaneIntersection(poly);
    cout<<setprecision(2)<<fixed<<polygoanArea(poly)<<endl;
  }
  return 0;
}