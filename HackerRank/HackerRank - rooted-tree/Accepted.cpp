/****************************************************************************************
*  @author: kzvd4729                                         created: 2019-02-28 14:56:09                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time (ms): 7848                                       memory_used (MB):                                 
...
long qry(long node,long lo,long hi,long lt,long rt)
{
  ...
  if(lo>=lt&&hi<=rt)return seg[node].smv;
  long md=(lo+hi)/2;
