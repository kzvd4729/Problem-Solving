/****************************************************************************************
*  @author: kzvd4729                                         created: 2019-01-23 14:58:56                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time: 0                                               memory_used:                                      
*  problem: https://vjudge.net/problem/UVA-11834
****************************************************************************************/
#include<bits/stdc++.h>
...
////////////////////////////////////////////////////
bool ckr(int a,int b,int c,int d,int r1,int r2)
{
  point p1={a*1.0,b*1.0},p2={c*1.0,d*1.0};
  double ds=Dist(p1,p2);
  if(ds>=(r1+r2)*1.0)return true;
  return false;
}
int main()
{
  ...
  {
    if(!(a+b+c+d))break;
    if(c+c>a||c+c>b||d+d>a||d+d>b)
    {
      cout<<"N"<<endl;continue;
    }
    int ans=0;
    ans|=ckr(c,c,d,a-d,c,d);
    ans|=ckr(c,c,d,b-d,c,d);
    ans|=ckr(c,c,a-d,b-d,c,d);
