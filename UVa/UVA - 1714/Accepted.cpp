/****************************************************************************************
*  @author: kzvd4729                                         created: 2019-03-25 22:32:32                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time: 2830                                            memory_used:                                      
...
int lt[N+2][N+2],rt[N+2][N+2],up[N+2][N+2],dw[N+2][N+2],sz;
char mt[N+2][N+2],s[10004];
void bfs(void)
{
  for(int l=0;l<=sz;l++)
    for(int i=1;i<=n;i++)
