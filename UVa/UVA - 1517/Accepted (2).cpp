/****************************************************************************************
*  @author: kzvd4729                                         created: 2019-10-18 22:13:08                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time: 120                                             memory_used:                                      
*  problem: https://vjudge.net/problem/UVA-1517
****************************************************************************************/
#include<bits/stdc++.h>
...
//      cout<<wall[i].s.x<<" *** "<<wall[i].e.x<<endl;
    ...
    while(product--)
    {
      ...
      for(int cl=max(0,p.y-radius);cl<=min(C+C,p.y+radius);cl++)
      {
        ...
        while(i<col[cl].size())
        {
          ...
          if(f<=radius&&d<=(radius-f)*(radius-f))
