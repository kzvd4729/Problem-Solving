/****************************************************************************************
*  @author: kzvd4729                                         created: 2020-03-02 15:52:51                      
...
int main()
{
  ...
  while(t--)
  {
    ...
    l2.makeLine(a,ret(a,b,(ang3/3.0)*2.0));
    point e=l1.intersection(l2);

    l1.makeLine(a,ret(a,b,ang3/3.0));
    l2.makeLine(b,ret(b,c,(ang1/3.0)*2.0));
    point f=l1.intersection(l2);
