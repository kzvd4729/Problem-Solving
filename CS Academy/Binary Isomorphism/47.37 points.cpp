...
*  solution_verdict: 47.37 points                            language: C++                                     
*  run_time: 104 ms                                          memory_used: 10116 KB                             
*  problem: 
****************************************************************************************/
#include<bits/stdc++.h>
...
bool dfs(int nod1,int nod2)
{
  ...
  return (dfs(adj1[nod1][0],adj2[nod2][0])&&dfs(adj1[nod1][1],adj2[nod2][1]))||(dfs(adj1[nod1][0],adj2[nod2][1])&&dfs(adj1[nod1][0],adj2[nod2][1]));
}
int main()
{
