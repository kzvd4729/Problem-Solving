/****************************************************************************************
*  @author: kzvd4729                                         created: 2020-01-21 18:52:59                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time (ms): 155                                        memory_used (MB): 5.5                             
...
int main()
{
  ...
  while(t--)
  {
    ...
    /*memset(srad,0,sizeof(srad));
    memset(snad,0,sizeof(snad));
    ...
    {
      cout<<"yes\n";
      for(int i=1;i<=m;i++)cout<<mn[i]+ed[bb[i]].f<<"\n";
    }
    clear();
  }
  return 0;
