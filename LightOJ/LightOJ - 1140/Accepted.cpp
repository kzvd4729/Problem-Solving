/****************************************************************************************
*  @author: kzvd4729                                         created: 2018-05-04 21:05:57                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time (ms): 440                                        memory_used (MB): 1.7                             
...
long dfs(long st,long ck,long cnt,long f)
{
  ...
  if(dp[st][ck][cnt][f]!=-1)return dp[st][ck][cnt][f];
  long here=0;
  for(long i=0;i<10;i++)
  {
    if(ck==0)
