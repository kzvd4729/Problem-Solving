/****************************************************************************************
*  @author: kzvd4729                                         created: 2019-05-13 21:53:29                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time (ms): 1768                                       memory_used (MB): 8.1                             
...
int main()
{
  ...
  {
    cin>>n;int con=0;
    for(int i=1;i<=n;i++)cin>>aa[i],con+=aa[i];
    int id=(n+1)%2,di;con/=2;
