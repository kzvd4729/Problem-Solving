/****************************************************************************************
*  @author: kzvd4729                                         created: 2020-01-22 00:02:18                      
*  solution_verdict: Accepted                                language: C++                                     
*  run_time (ms): 48                                         memory_used (MB): 5.8                             
*  problem: https://vjudge.net/problem/LightOJ-1286
****************************************************************************************/
#include<bits/stdc++.h>
...
int main()
{
  ...
  while(t--)
  {
    int n,m;cin>>n>>m;sn=n+m+1;int sm=0;
    for(int i=1;i<=n;i++)
    {
      int x;cin>>x;addEdge(sr,i,x);sm+=x;
    }
    for(int i=1;i<=m;i++)
    {
      int x;cin>>x;addEdge(n+i,sn,x);
    }
    for(int i=1;i<=n;i++)
    {
      int q;cin>>q;
